...
// index -> scanCode, value -> ascii code
// NO == 0, 0x1B -> esc
static uchar normalmap[256] =
{
	NO,   0x1B, '1',  '2',  '3',  '4',  '5',  '6',  // 0x00 (prvih 8)
	'7',  '8',  '9',  '0',  '-',  '=',  '\b', '\t',
	...
	[0x9C] '\n',      // KP_Enter (indeksiranje gde preskocim nule do njega)
	[0xB5] '/',       // KP_Div
...
static uchar ctlmap[256] =
{
	...
	NO,      NO,      NO,      NO,      NO,      NO,      NO,      NO,
	C('Q'),  C('W'),  C('E'),  C('R'),  C('T'),  C('Y'),  C('U'),  C('I'), // makroi
